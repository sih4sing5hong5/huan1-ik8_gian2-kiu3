...
from build.lib.臺灣言語工具.斷詞.型音辭典 import 型音辭典
class 數位標字:
	__語料=讀語料()
	def 標字(self, 辭典,連詞, 閩南語字檔名,閩南語音檔名):
		__分析器 = 拆文分析器()
		__粗胚 = 文章粗胚()
		__家私 = 轉物件音家私()
		__譀鏡 = 物件譀鏡()
...
if __name__ == '__main__':
	...
	語料 = 讀語料()
	連詞 = 語句連詞(3)
	語料.產生連詞(連詞,'../語料/附錄句閩南語字.txt.gz',
			'../語料/附錄句閩南語音.txt.gz')
	語料.產生連詞(連詞,'../語料/訓.例句閩南語字.txt.gz',
			'../語料/訓.例句閩南語音.txt.gz')
	語料.產生連詞(連詞,'../語料/訓.華臺閩南語字.txt.gz',
			'../語料/訓.華臺閩南語音.txt.gz')
	標字.標字(連詞, '../語料/訓.華臺閩南語音.txt',
		 '../語料/訓.華臺閩南語音.txt')
