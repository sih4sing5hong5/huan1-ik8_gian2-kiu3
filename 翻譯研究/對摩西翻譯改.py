...
# 			print(一逝)
			翻譯結果 = self.用戶端.翻譯(一逝, 另外參數={'nbest':self.摩西揀幾个})
			全部句 = []
...
# 					print(一个詞)
			...
			if self.摩西揀幾个 > 1:
				...
				上好物件 = 全部句[0]
			print(譀鏡.看斷詞(上好物件, 分字音符號='｜', 物件分字符號='-', 物件分詞符號=' '))
			print(譀鏡.看斷詞(上好物件, 分字音符號='｜', 物件分字符號='-', 物件分詞符號=' '), file=結果檔案)
